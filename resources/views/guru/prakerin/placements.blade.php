<x-simans-layout title="Penempatan Siswa - Prakerin">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-400 text-sm mt-1">Assign siswa ke DU/DI yang Anda bimbing</p>
        </div>
    ...
    <div class="flex gap-2 mb-5 flex-wrap">
        ...
        <a href="{{ route('guru.prakerin.placements') }}" class="px-4 py-2 rounded-xl text-sm font-medium bg-emerald-500 text-white">Penempatan Siswa</a>
    ...
    @if (! $period)
        <div class="bg-gray-900 border border-white/5 rounded-2xl p-8 text-center">
            <p class="text-gray-400">Anda belum ditunjuk sebagai koordinator di periode manapun.</p>
        </div>
    ...
    @elseif ($placements->isEmpty())
        <div class="bg-gray-900 border border-white/5 rounded-2xl p-12 text-center">
            <p class="text-gray-400">Belum ada siswa yang ditempatkan di lokasi Anda.</p>
        </div>
    @else
                ...
                <tbody class="divide-y divide-white/5">
                    @foreach ($placements as $p)
                        <tr class="hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-5 py-3 text-gray-300">{{ $p->location->name }}</td>
            ...
            <form action="{{ route('guru.prakerin.placements.store') }}" method="POST" class="space-y-3">
                ...
                <div>
                    ...
                    @if ($placedStudents->count() > 0)
                        <p class="text-gray-600 text-xs mt-1">Siswa yang sudah ditempatkan ditandai dan tidak bisa dipilih.</p>
                    @endif
                </div>
                <div>
