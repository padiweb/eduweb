<x-simans-layout title="Rekap Jurnal Prakerin">
    ...
    <div class="flex gap-2 mb-5 flex-wrap">
        ...
        <a href="{{ route('guru.prakerin.recap.jurnal') }}" class="px-4 py-2 rounded-xl text-sm font-medium bg-emerald-500 text-white">Rekap Jurnal</a>
    </div>
    ...
    <div class="flex flex-wrap gap-3 mb-5">
        ...
        <select onchange="window.location = '{{ route('guru.prakerin.recap.jurnal') }}?period_id={{ $periodId }}&location_id=' + this.value"
