<x-simans-layout title="Rekap Jurnal Prakerin">
    ...
    <div class="flex gap-2 mb-5 overflow-x-auto pb-1 -mx-4 px-4 scrollbar-none">
        ...
        <a href="{{ route('guru.prakerin.recap.jurnal') }}" class="flex-shrink-0 px-4 py-2 rounded-xl text-sm font-medium bg-blue-600 text-gray-900">Rekap Jurnal</a>
    </div>
    ...
    @else
        {{-- Step 2: Pilih DU/DI --}}
        <div class="mb-5">
            <label class="block text-xs text-gray-400 mb-2 font-medium uppercase tracking-wider">Pilih DU/DI</label>
        ...
        @else
            {{-- Step 3: Daftar siswa --}}
            <p class="text-xs text-gray-400 mb-3 font-medium uppercase tracking-wider">
            ...
            <div class="space-y-2">
                @foreach ($placements as $p)
                    ...
                    <a href="{{ route('guru.prakerin.recap.jurnal.detail', $p) }}"
                       class="flex items-center gap-4 bg-white border border-gray-200 hover:border-amber-500/30 rounded-2xl px-5 py-4 transition-colors group">
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                            ...
                            @endif
                            <svg class="w-4 h-4 text-gray-400 group-hover:text-amber-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
