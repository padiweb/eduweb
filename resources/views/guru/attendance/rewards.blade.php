<x-simans-layout title="Poin Reward Saya">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-white">Poin Reward Saya</h1>
        <p class="text-gray-400 text-sm mt-1">Poin terkumpul dari absensi tepat waktu dan jurnal mengajar</p>
    </div>

    {{-- Ringkasan --}}
    <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="bg-gray-900 border border-white/5 rounded-xl p-4 text-center">
            <p class="text-2xl font-bold text-emerald-400">{{ $summary['this_month'] }}</p>
    ...
    <div class="bg-gray-900 border border-white/5 rounded-xl overflow-hidden">
        <div class="px-5 py-4 border-b border-white/5">
            <h2 class="text-sm font-semibold text-white">Riwayat Poin</h2>
        </div>
        @if($points->isEmpty())
        ...
        @else
                ...
                @foreach($points as $pt)
                    ...
                    <div class="flex items-center gap-3 px-5 py-3.5">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-white">{{ $pt->typeLabel }}</p>
                            @if($pt->description)
            ...
            <div class="px-5 py-4 border-t border-white/5">{{ $points->links() }}</div>
        @endif
    </div>
