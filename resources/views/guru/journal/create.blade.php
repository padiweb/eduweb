            ...
            <div class="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              ...
                              class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-blue-500 resize-none transition-colors">{{ old('description', $existing?->description ?? '') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="students_present" min="0"
                               ...
                               class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-blue-500 transition-colors">
                        <p class="text-xs text-gray-500 mt-1">Total: {{ $schedule->classroom->students->count() }} siswa</p>
                    </div>
                    <div>
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2"
                              ...
                              class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-blue-500 resize-none transition-colors">{{ old('notes', $existing?->notes ?? '') }}</textarea>
                </div>
            </div>

            {{-- Info poin --}}
            @if(! $existing?->is_reward_given)
                <div class="flex items-center gap-3 bg-emerald-50 border border-blue-200 rounded-xl px-4 py-3">
