<x-simans-layout title="Detail Tugas">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm mt-0.5">{{ $assignment->subject->name }} &middot; {{ $assignment->teacher->name }}</p>
    </div>
                ...
                <div class="bg-white border {{ $submission ? 'border-blue-200' : 'border-gray-200' }} rounded-xl p-5">
                    ...
                    <form method="POST"
                        ...
                        @if(in_array($assignment->submission_type, ['link', 'any']))
                            <div>
                                <label class="block text-xs text-gray-500 mb-1.5">Link</label>
                        ...
                        <div id="upload-progress" class="hidden">
                            <div class="flex items-center justify-between mb-1">
                                <span class="text-xs text-gray-500">Mengupload file...</span>
                                <span id="progress-pct" class="text-xs text-blue-600">0%</span>
                            </div>
