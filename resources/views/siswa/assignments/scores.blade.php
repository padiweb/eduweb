<x-simans-layout title="Nilai Saya">
                ...
                <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                    <div class="flex items-center justify-between px-5 py-4 border-b border-gray-200">
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-0.5">{{ $row['graded_count'] }} dari {{ $row['total'] }} tugas sudah dinilai</p>
                        </div>
                        @if($row['average'] !== null)
    ...
    @else
        <div class="bg-white border border-gray-200 rounded-xl p-12 text-center">
            ...
            <p class="text-gray-400 text-sm">Belum ada nilai. Kumpulkan tugas terlebih dahulu.</p>
        </div>
    @endif
