<x-simans-layout title="Tahun Ajaran">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Kelola tahun ajaran dan semester aktif</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
            <div class="bg-white border border-blue-200 rounded-xl p-5">
                <h2 class="text-sm font-semibold text-gray-900 mb-4">Tambah Tahun Ajaran</h2>
                            ...
                            <div class="flex items-center gap-4 px-5 py-4">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        ...
                                        <span class="text-xs {{ $ay->semester == 1 ? 'text-blue-600 bg-blue-50 border-blue-200' : 'text-blue-600 bg-blue-50 border-blue-200' }} border px-2 py-0.5 rounded-full">
