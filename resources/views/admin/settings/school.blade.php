<x-simans-layout title="Pengaturan Sekolah">
    ...
    <form method="POST" action="{{ route('admin.settings.school.update') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="mb-5 pb-5 border-b border-gray-200">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-16 h-16 rounded-xl bg-white border border-gray-200 flex items-center justify-center overflow-hidden flex-shrink-0" id="logo-preview-wrap">
                                ...
                                @else
                                    <svg class="w-7 h-7 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" id="logo-placeholder">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342"/>
                                    </svg>
                            ...
                            <div>
                                <label for="logo-input" class="cursor-pointer inline-flex items-center gap-2 bg-white hover:bg-gray-100 border border-gray-200 text-gray-600 text-xs font-medium px-4 py-2 rounded-lg transition-colors">
                                ...
                                <input type="file" name="logo" id="logo-input" accept="image/png,image/jpeg,image/webp" class="hidden"
                                    ...
                                    ">
                                <p class="text-xs text-gray-400 mt-1.5">PNG, JPG, WebP · Maks 2MB</p>
                                <p class="text-xs text-gray-400">Disarankan ukuran minimal 200×200px</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $school->name) }}"
                                   class="w-full bg-white border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-200' }} text-gray-900 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="address" rows="2"
                                      class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors resize-none"
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-5">
                    ...
                    <p class="text-gray-400 text-xs mb-4">Siswa hanya bisa scan QR dalam rentang jam buka hingga jam tutup.</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="time" name="school_start_time"
                                   ...
                                   class="w-full bg-white border {{ $errors->has('school_start_time') ? 'border-red-500' : 'border-gray-200' }} text-gray-900 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                        ...
                        <div>
                            ...
                            <input type="time" name="late_threshold_time"
                                   ...
                                   class="w-full bg-white border {{ $errors->has('late_threshold_time') ? 'border-red-500' : 'border-gray-200' }} text-gray-900 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                        ...
                        <div>
                            ...
                            <input type="time" name="attendance_close_time"
                                   ...
                                   class="w-full bg-white border {{ $errors->has('attendance_close_time') ? 'border-red-500' : 'border-gray-200' }} text-gray-900 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-5">
                    ...
                    <p class="text-gray-400 text-xs mb-4">Poin otomatis diberikan tiap hari jika siswa tidak absen/tidak isi jurnal</p>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input type="number" name="prakerin_points_no_checkin" min="0" max="99"
                                       ...
                                       class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                                <span class="text-gray-400 text-sm whitespace-nowrap">poin</span>
                            </div>
                        </div>
                        <div>
            ...
            <div class="space-y-5">
                <div class="bg-white border border-gray-200 rounded-xl p-5">
                    ...
                    <div class="space-y-3 mb-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="attendance_radius_meters"
                                   ...
                                   min="50" max="1000"
                                   class="w-full bg-white border {{ $errors->has('attendance_radius_meters') ? 'border-red-500' : 'border-gray-200' }} text-gray-900 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                            <p class="text-gray-400 text-xs mt-1">Minimal 50m, maksimal 1000m. Rekomendasi: 200m</p>
                    ...
                    <p id="detect-status" class="text-xs text-center text-gray-400"></p>
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-5">
            ...
            <p class="text-xs text-gray-400 mb-4">Sesi masuk dan pulang dibuat otomatis sesuai jam di bawah.</p>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="flex items-end">
                    <a href="{{ route('admin.teacher-attendance.qr') }}"
                       target="_blank"
                       class="w-full flex items-center justify-center gap-2 bg-white hover:bg-gray-100 border border-gray-200 text-gray-600 text-sm px-4 py-2.5 rounded-xl transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="sm:col-span-3 mt-2">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Perbarui QR jika QR lama hilang atau rusak. Cetak ulang QR setelah diperbarui.</p>
                </div>
            </div>
        </div>
