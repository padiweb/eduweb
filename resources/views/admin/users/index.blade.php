<x-simans-layout title="Manajemen User">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Kelola akun siswa, guru, dan staff sekolah</p>
        </div>
        ...
        @if($users->count() > 0)
            <div class="divide-y divide-gray-100">
                @foreach($users as $user)
                    ...
                    @endphp
                    <div class="flex items-center gap-3 px-5 py-4 hover:bg-gray-50 transition-colors">

                        {{-- Avatar --}}
                        <div class="w-10 h-10 rounded-full overflow-hidden bg-white flex-shrink-0 ring-2 ring-white/5">
