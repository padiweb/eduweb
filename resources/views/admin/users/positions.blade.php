        ...
        <div>
            <div class="bg-white border border-blue-200 rounded-xl p-5">
                ...
                <form method="POST" action="{{ route('admin.users.positions.store') }}" class="space-y-3">
                    @csrf
                    <div>
                        <label class="block text-xs text-gray-500 mb-1.5">Nama Jabatan <span class="text-red-600">*</span></label>
                    ...
                    <div class="divide-y divide-gray-100">
                        @foreach($positions as $pos)
                            <div class="flex items-center gap-4 px-5 py-3.5">
                                <div class="w-8 h-8 rounded-full bg-blue-50 border border-blue-200 flex items-center justify-center flex-shrink-0">
