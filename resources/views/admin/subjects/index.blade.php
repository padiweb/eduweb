<x-simans-layout title="Mata Pelajaran">
    ...
    <div class="flex gap-1 mb-6 bg-white border border-gray-200 rounded-xl p-1 w-fit">
        <a href="{{ route('admin.subjects.index', ['tab' => 'subjects']) }}"
           class="px-4 py-1.5 rounded-lg text-sm font-medium transition-colors {{ $activeTab === 'subjects' ? 'bg-blue-600 text-white' : 'text-gray-500 hover:text-blue-600' }}">
            Mata Pelajaran
        </a>
        <a href="{{ route('admin.subjects.index', ['tab' => 'groups']) }}"
           class="px-4 py-1.5 rounded-lg text-sm font-medium transition-colors {{ $activeTab === 'groups' ? 'bg-blue-600 text-white' : 'text-gray-500 hover:text-blue-600' }}">
            Kelola Kelompok
        </a>
    </div>
