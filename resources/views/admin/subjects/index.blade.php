<x-simans-layout title="Mata Pelajaran">
    ...
    <div class="flex gap-1 mb-6 bg-gray-900 border border-white/5 rounded-xl p-1 w-fit">
        <a href="{{ route('admin.subjects.index', ['tab' => 'subjects']) }}"
           class="px-4 py-1.5 rounded-lg text-sm font-medium transition-colors {{ $activeTab === 'subjects' ? 'bg-emerald-500 text-white' : 'text-gray-400 hover:text-white' }}">
            Mata Pelajaran
        </a>
        <a href="{{ route('admin.subjects.index', ['tab' => 'groups']) }}"
           class="px-4 py-1.5 rounded-lg text-sm font-medium transition-colors {{ $activeTab === 'groups' ? 'bg-emerald-500 text-white' : 'text-gray-400 hover:text-white' }}">
            Kelola Kelompok
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div>
            ...
            <div class="mt-4 bg-gray-900 border border-white/5 rounded-xl p-4 space-y-3">
                <div>
                    <p class="text-xs font-semibold text-gray-400 mb-1">Contoh SMK:</p>
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 mb-1">Contoh SMP:</p>
                    <div class="space-y-0.5 text-xs text-gray-600">
