<div class="flex items-center gap-4 px-5 py-3.5" x-data="{ editing: false }">
    ...
    <form method="POST" action="{{ route('admin.subjects.update', $subject->id) }}"
        ...
        <div class="flex gap-2">
            <button type="submit" class="flex-1 text-xs text-blue-600 bg-blue-50 border border-blue-200 hover:bg-blue-50 py-1.5 rounded-lg transition-colors">Simpan</button>
