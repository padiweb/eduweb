                        ...
                        @foreach($majors as $major)
                            <div class="flex items-center gap-4 px-5 py-4" x-data="{ editing: false }">
                                ...
                                <form method="POST" action="{{ route('admin.majors.update', $major->id) }}"
                                    ...
                                    <button type="button" @click="editing=false" class="text-xs text-gray-500 hover:text-gray-900 px-2 py-1.5 bg-white border border-gray-200 rounded-lg transition-colors">
                                        Batal
                                    </button>
                                </form>
