...
<p id="{{ ($isEdit ?? false) ? 'edit-gps-status' : 'add-gps-status' }}" class="text-gray-400 text-xs -mt-1"></p>
...
<div class="grid grid-cols-3 gap-3">
    <div>
        ...
        <input type="time" name="checkin_time"
               class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500">
        <p class="text-gray-400 text-xs mt-0.5">Jam masuk DU/DI ini</p>
    </div>
    <div>
        <label class="block text-xs text-gray-500 mb-1">Batas Toleransi</label>
        <input type="time" name="checkin_late_after"
               class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500">
        <p class="text-gray-400 text-xs mt-0.5">Setelah ini = terlambat</p>
    </div>
    <div>
