...
<div>
    <label class="block text-xs text-gray-400 mb-1">Nama DU/DI <span class="text-red-400">*</span></label>
...
<div class="flex items-center gap-3">
    <div class="flex-1">
        <label class="block text-xs text-gray-400 mb-1">Radius Check-in (meter) <span class="text-red-400">*</span></label>
...
<p id="{{ ($isEdit ?? false) ? 'edit-gps-status' : 'add-gps-status' }}" class="text-gray-600 text-xs -mt-1"></p>
...
<div class="grid grid-cols-3 gap-3">
    <div>
        ...
        <input type="time" name="checkin_time"
               class="w-full bg-gray-800 border border-white/10 text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500">
        <p class="text-gray-600 text-xs mt-0.5">Jam masuk DU/DI ini</p>
    </div>
    <div>
        <label class="block text-xs text-gray-400 mb-1">Batas Toleransi</label>
        <input type="time" name="checkin_late_after"
               class="w-full bg-gray-800 border border-white/10 text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500">
        <p class="text-gray-600 text-xs mt-0.5">Setelah ini = terlambat</p>
    </div>
    <div>
...
<div class="grid grid-cols-2 gap-3">
    <div>
        <label class="block text-xs text-gray-400 mb-1">Nama Pembimbing Lapangan</label>
...
<div>
    <label class="block text-xs text-gray-400 mb-2">Guru Pembimbing (dari sekolah, bisa lebih dari 1)</label>
