<x-simans-layout title="Edit Penempatan Prakerin">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-white">Edit Penempatan Prakerin</h1>
        <p class="text-gray-400 text-sm mt-1">{{ $placement->student->name }}</p>
    </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-gray-900 border border-white/5 rounded-2xl p-5">
                ...
                <div class="flex items-center gap-3 p-3 bg-gray-800/50 rounded-xl">
                    <div class="w-8 h-8 rounded-full bg-emerald-900 border border-emerald-700/50 flex items-center justify-center text-xs font-bold text-emerald-400">
                        {{ substr($placement->student->name, 0, 1) }}
                    </div>
                    <div>
                        <p class="text-white text-sm font-medium">{{ $placement->student->name }}</p>
            ...
            {{-- Data DU/DI --}}
            <div class="bg-gray-900 border border-white/5 rounded-2xl p-5">
                <h2 class="text-sm font-semibold text-white mb-4">Data DU/DI</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="company_address" rows="2"
                                  class="w-full bg-gray-800 border border-white/10 text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors resize-none">{{ old('company_address', $placement->company_address) }}</textarea>
                    </div>
                    <div>
                    ...
                    <p id="gps-status" class="text-gray-600 text-xs md:col-span-2"></p>
                </div>
            </div>

            {{-- Pembimbing Lapangan --}}
            <div class="bg-gray-900 border border-white/5 rounded-2xl p-5">
                <h2 class="text-sm font-semibold text-white mb-4">Pembimbing Lapangan</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-400 mb-1.5">No. HP</label>
            ...
            {{-- Periode & Status --}}
            <div class="bg-gray-900 border border-white/5 rounded-2xl p-5">
                <h2 class="text-sm font-semibold text-white mb-4">Periode & Status</h2>
        ...
        function detectLocation() {
            ...
            navigator.geolocation.getCurrentPosition(
                (pos) => {
                    ...
                    status.className = 'text-emerald-400 text-xs md:col-span-2';
                },
                () => {
