    ...
    <form action="{{ route('admin.prakerin.placements.store') }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-400 text-xs mt-1">Hanya siswa tanpa penempatan aktif yang tampil</p>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="company_name" value="{{ old('company_name') }}"
                               ...
                               class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors placeholder-gray-400">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea name="company_address" rows="2"
                                  ...
                                  class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors placeholder-gray-400 resize-none">{{ old('company_address') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="radius_meters" value="{{ old('radius_meters', 300) }}"
                               ...
                               class="w-full bg-white border border-gray-200 text-gray-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 transition-colors">
                        <p class="text-gray-400 text-xs mt-1">Siswa harus berada dalam radius ini untuk absen</p>
                    </div>
                    <div class="flex items-end">
                        <button type="button" onclick="detectLocation()"
                                id="btn-detect"
                                class="w-full py-2.5 bg-white hover:bg-gray-100 border border-gray-200 text-gray-600 text-sm rounded-xl transition-colors flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="md:col-span-2">
                        <p id="gps-status" class="text-gray-400 text-xs"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-3 justify-end">
                <a href="{{ route('admin.prakerin.placements.index') }}"
                   class="px-5 py-2.5 bg-white hover:bg-gray-100 border border-gray-200 text-gray-600 text-sm rounded-xl transition-colors">
                    Batal
                </a>
                <button type="submit"
                        class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-gray-900 text-sm font-semibold rounded-xl transition-colors">
                    Simpan Penempatan
                </button>
            </div>
        </div>
