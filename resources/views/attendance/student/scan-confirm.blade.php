...
<div class="w-full max-w-sm">
    ...
    <div id="state-submitting" class="text-center hidden">
        ...
        <p class="text-gray-500 text-sm">Menyimpan absensi...</p>
    </div>
    ...
    <div id="state-success" class="text-center hidden">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-4 text-left mb-4">
            ...
            <div class="flex justify-between text-sm py-2 border-t border-gray-200">
                <span class="text-gray-500">Status</span>
                <span class="font-semibold" id="success-status"></span>
            </div>
            <div class="flex justify-between text-sm py-2 border-t border-gray-200">
                <span class="text-gray-500">Waktu</span>
                <span class="text-gray-900" id="success-time"></span>
            </div>
        </div>
        <a href="{{ route('siswa.attendance.history') }}" class="block w-full text-center text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors py-2">
