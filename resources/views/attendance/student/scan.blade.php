    ...
    <div id="state-ready" class="hidden">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-4 mb-4">
            <div class="flex items-center gap-3">
                <div class="w-12 h-12 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center text-base font-bold text-blue-600 flex-shrink-0">
    ...
    document.getElementById('btn-absen')?.addEventListener('click', async function() {
        ...
        try {
            ...
            if (data.success) {
                ...
                subtitleEl.className   = data.is_late ? 'text-sm mb-6 text-amber-600' : 'text-sm mb-6 text-blue-600';
                statusEl.textContent   = data.status_label;
                statusEl.className     = data.is_late ? 'text-sm font-bold text-amber-600' : 'text-sm font-bold text-blue-600';
