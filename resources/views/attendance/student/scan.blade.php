...
<div class="w-full max-w-sm mx-auto">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="font-bold text-white">SiManS</h1>
    ...
    <div id="state-gps-error" class="text-center hidden">
        ...
        <p class="text-gray-400 text-sm mb-6" id="gps-error-msg">Izinkan akses lokasi di pengaturan browser</p>
        <button onclick="requestGPS()"
                class="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-3.5 rounded-2xl transition-colors">
            Coba Lagi
        </button>
    </div>
    ...
    <div id="state-success" class="text-center hidden">
        ...
        <div class="bg-gray-900 border border-white/5 rounded-2xl divide-y divide-white/5 text-left mb-5">
    ...
    document.getElementById('btn-absen')?.addEventListener('click', async function() {
        ...
        try {
            ...
            if (data.success) {
                ...
                subtitleEl.className   = data.is_late ? 'text-sm mb-6 text-amber-400' : 'text-sm mb-6 text-emerald-400';
                statusEl.textContent   = data.status_label;
                statusEl.className     = data.is_late ? 'text-sm font-bold text-amber-400' : 'text-sm font-bold text-emerald-400';
