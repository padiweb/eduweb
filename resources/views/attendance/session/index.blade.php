<x-simans-layout title="Absensi Siswa">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('guru.attendance.create') }}"
           class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-gray-900 text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                @else
                                    <span class="text-xs font-semibold text-gray-400 bg-white border border-gray-200 px-2.5 py-0.5 rounded-full">
                                        Ditutup
                                    </span>
                                @endif
                            </div>
    ...
    @else
        <div class="bg-white border border-gray-200 rounded-xl p-12 text-center mb-6">
            ...
            <p class="text-gray-400 text-sm">Belum ada sesi absensi hari ini</p>
