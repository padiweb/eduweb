                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                @if($session->isActive())
                                    <span class="flex items-center gap-1.5 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 px-2.5 py-0.5 rounded-full">
                            ...
                            <div class="flex items-center gap-4 text-xs text-gray-500">
                                ...
                                @if($session->isActive())
                                    <span class="text-amber-700">Kedaluwarsa {{ $session->token_expires_at->format('H:i') }}</span>
                                @endif
                            </div>
                        </div>
