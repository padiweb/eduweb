<x-simans-layout title="Dashboard Bendahara">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <x-stat-card label="Tagihan Bulan Ini"      :value="$stats['tagihan_bulan_ini']"   color="purple" sub="Total tagihan dibuat"/>
        <x-stat-card label="Sudah Lunas"             :value="$stats['lunas_bulan_ini']"     color="green"  sub="Bulan ini"/>
        <x-stat-card label="Menunggu Konfirmasi"     :value="$stats['menunggu_konfirmasi']" color="amber"  sub="Upload bukti transfer"/>
    ...
    <div class="bg-gray-900 border border-white/5 rounded-xl p-5">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            <a href="#" class="flex items-center gap-3 bg-gray-800 hover:bg-gray-700 border border-white/5 rounded-xl p-4 transition-colors">
                ...
                <span class="text-sm font-medium text-white">Laporan & Rekap</span>
            </a>
            <a href="#" class="flex items-center gap-3 bg-gray-800 hover:bg-gray-700 border border-white/5 rounded-xl p-4 transition-colors">
            ...
            <a href="#" class="flex items-center gap-3 bg-gray-800 hover:bg-gray-700 border border-white/5 rounded-xl p-4 transition-colors">
                ...
                <span class="text-sm font-medium text-white">Pengaturan Tarif</span>
            </a>
        </div>
    </div>
</x-simans-layout>