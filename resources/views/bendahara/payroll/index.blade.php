<x-simans-layout title="Penggajian">
    ...
    <div class="mb-6">
        <h1 class="text-xl font-bold text-white">Penggajian Guru & Karyawan</h1>
        <p class="text-gray-400 text-sm mt-0.5">Kelola gaji pokok, tunjangan JP, dan tunjangan jabatan</p>
    </div>

    {{-- Coming soon card --}}
    <div class="bg-gray-900 border border-white/5 rounded-xl p-12 text-center">
        <div class="w-16 h-16 bg-green-500/10 border border-green-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
        ...
        <h2 class="text-white font-semibold text-lg mb-2">Modul Penggajian</h2>
