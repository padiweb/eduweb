<x-simans-layout title="Penggajian">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-12 text-center">
        <div class="w-16 h-16 bg-green-50 border border-green-200 rounded-xl flex items-center justify-center mx-auto mb-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-lg mx-auto text-left">
            ...
            <div class="bg-white rounded-xl p-4">
                <svg class="w-5 h-5 text-green-600 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
