<x-simans-layout title="Keuangan Sekolah">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div class="bg-white border border-gray-200 rounded-xl p-5">
            <p class="text-xs text-gray-400 mb-1 uppercase tracking-wide">Total Pemasukan</p>
            <p class="text-xl font-bold text-green-400">Rp {{ number_format($totalIncome, 0, ',', '.') }}</p>
        </div>
        <div class="bg-white border border-gray-200 rounded-xl p-5">
            <p class="text-xs text-gray-400 mb-1 uppercase tracking-wide">Total Pengeluaran</p>
        ...
        <div class="bg-white border border-{{ $totalBalance >= 0 ? 'green' : 'red' }}-500/20 rounded-xl p-5">
            <p class="text-xs text-gray-400 mb-1 uppercase tracking-wide">Saldo</p>
            <p class="text-xl font-bold {{ $totalBalance >= 0 ? 'text-gray-900' : 'text-red-400' }}">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            @if($sources->isEmpty())
                <div class="px-5 py-8 text-center">
                    <p class="text-gray-400 text-sm">Belum ada sumber dana.</p>
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="px-5 py-3.5 flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <p class="text-sm font-semibold {{ $source->balance >= 0 ? 'text-gray-900' : 'text-red-400' }}">
        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            @if($pendingExpenses->isEmpty())
                <div class="px-5 py-8 text-center">
                    <p class="text-gray-400 text-sm">Tidak ada pengeluaran yang menunggu approval.</p>
                </div>
            @else
                <div class="divide-y divide-gray-100">
