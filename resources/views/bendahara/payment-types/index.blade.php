<x-simans-layout title="Jenis & Tarif Pembayaran">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Jenis & Tarif Pembayaran</h1>
            <p class="text-gray-500 text-sm mt-0.5">Setup jenis pembayaran dan tarif per kelas/jurusan</p>
        </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl mb-4 overflow-hidden" x-data="{ open: false }">
        <div class="flex items-center gap-4 px-5 py-4 cursor-pointer" @click="open = !open">
            ...
            <div class="flex items-center gap-3">
                ...
                <form method="POST" action="{{ route('bendahara.payment-types.destroy', $type) }}"
        ...
        <div x-show="open" x-cloak class="border-t border-gray-200 px-5 py-4">
...
@include('bendahara.bills.generate-spp-modal')
