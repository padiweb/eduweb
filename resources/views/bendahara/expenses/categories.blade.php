<x-simans-layout title="Kategori Pengeluaran">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-bold text-white">Kategori Pengeluaran</h1>
            <p class="text-gray-400 text-sm mt-0.5">Setup kategori dan batas approval</p>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/2 transition-colors">
                        ...
                        <td class="px-4 py-3 text-gray-400">{{ $cat->getTypeLabel() }}</td>
    ...
    <div id="modal-add" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4" x-data="{ req: false }">
        <div class="bg-gray-900 border border-white/10 rounded-2xl w-full max-w-md p-6">
            <h3 class="text-white font-semibold mb-4">Tambah Kategori</h3>
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="requires_approval" value="1" x-model="req" class="text-purple-500">
                            <span class="text-sm text-white">Membutuhkan approval kepala sekolah</span>
                        </label>
                    </div>
                    <div x-show="req" x-cloak>
                        <label class="text-xs text-gray-400 mb-1 block">Batas Nominal (Rp) — kosong = semua nominal</label>
    ...
    <div id="modal-edit" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4" x-data="{ req: false }">
        <div class="bg-gray-900 border border-white/10 rounded-2xl w-full max-w-md p-6">
            <h3 class="text-white font-semibold mb-4">Edit Kategori</h3>
            <form id="form-edit" method="POST" action="">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" id="edit-req" name="requires_approval" value="1" x-model="req" class="text-purple-500">
                            <span class="text-sm text-white">Membutuhkan approval</span>
                        </label>
                    </div>
                    <div x-show="req" x-cloak>
                        <label class="text-xs text-gray-400 mb-1 block">Batas Nominal (Rp)</label>
