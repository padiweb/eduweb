<x-simans-layout title="Kategori Pengeluaran">
    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        @if($categories->isEmpty())
            <div class="px-5 py-12 text-center"><p class="text-gray-400">Belum ada kategori.</p></div>
        @else
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200">
                        <th class="text-left text-xs text-gray-400 font-medium px-4 py-3">Nama</th>
                        <th class="text-left text-xs text-gray-400 font-medium px-4 py-3">Jenis</th>
                        <th class="text-center text-xs text-gray-400 font-medium px-4 py-3">Approval</th>
                        <th class="text-right text-xs text-gray-400 font-medium px-4 py-3">Batas Nominal</th>
                        <th class="text-right text-xs text-gray-400 font-medium px-4 py-3">Dipakai</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-white/2 transition-colors">
                        <td class="px-4 py-3">
                            ...
                            @if($cat->code) <span class="text-xs text-gray-400 ml-2">{{ $cat->code }}</span> @endif
                        </td>
                        ...
                        <td class="px-4 py-3 text-right text-gray-400">{{ $cat->expenses_count }}x</td>
                ...
                <div class="space-y-3">
                    ...
                    <div x-show="req" x-cloak>
                        ...
                        <input type="number" name="approval_threshold" min="0" placeholder="0 = semua nominal butuh approval"
                            class="w-full bg-white border border-gray-200 text-gray-700 text-sm rounded-lg px-3 py-2 focus:border-purple-500 focus:outline-none">
                        <p class="text-xs text-gray-400 mt-1">Isi 0 atau kosong = semua pengeluaran di kategori ini butuh approval</p>
                    </div>
                </div>
