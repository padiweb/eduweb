<x-simans-layout title="Anggota Program Beasiswa">
    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        @if($program->members->isEmpty())
            <div class="px-5 py-12 text-center">
                ...
                <p class="text-gray-500 text-xs mt-1">Klik Tambah Siswa untuk menambahkan massal.</p>
            </div>
        @else
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-white/2 transition-colors" x-data="{ editing: false }">
                            ...
                            <td class="px-4 py-3 text-center font-semibold text-blue-600 text-xs">
    ...
    <div id="modal-add-member" style="display:none" class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4"
        ...
        <div class="bg-white border border-gray-200 rounded-xl w-full max-w-lg p-6 max-h-screen overflow-y-auto">
            ...
            <input type="text" x-model="search" @input.debounce.400ms="doSearch()"
                ...
                class="w-full bg-white border border-gray-200 text-gray-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none mb-3">
                        ...
                        <template x-for="s in selectedList" :key="s.id">
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" :name="'overrides[' + s.id + ']'"
                                    ...
                                    class="w-32 bg-white border border-gray-200 text-gray-700 text-xs rounded px-2 py-1.5 focus:border-blue-500 focus:outline-none">
                                <span class="text-xs text-gray-500">{{ $program->discount_type === 'percent' ? '%' : 'Rp' }}</span>
                            </div>
                        </template>
                    </div>
